export function getAboutInfo() {
  ...
  Game of Education as a Game Designer & World Builder (2021 - 2024). Contributed to the success of multiple top performing projects through panning, design, testing. This includes projects such as "How to live inside an Axolotl", "TNT Tools" & "Summer Beach Bunker". Implemented my good sense of game design, story telling and gameplay into compelling projects.
...
export function getProjectsInfo() {
  return <div>getProjectsInfo</div>;
}
