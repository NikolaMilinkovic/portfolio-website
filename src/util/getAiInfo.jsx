...
export function getAboutInfo() {
  ...
  const aboutMeText = `name: Nikola Milinkovic, Web Developer, date of birth: 27.04.1997, current date for calculating the age is ${currentDate}, lives in Belgrade the capital city of Serbia. Not married.
 Languages:
 - Serbian (Native)
 - English (Proficient)
